# https://github.com/rishikksh20/ResUnet/blob/01566c9ca77184ec7ecbd21ddb0681b5941e63f4/configs/default.yaml
...
if __name__ == '__main__':
    ...
    path = "/content/data/kvasir_seg"
    dataset_name = "Kvasir-SEG"
    full_path = os.path.join(path, dataset_name)

    new_path = "/content/data/kvasir_seg_new"
    create_dir(new_path)
